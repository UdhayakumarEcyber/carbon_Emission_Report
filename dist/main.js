...
/***/ "./src/components/carbon_detailed_analysis.tsx":
/*!*****************************************************!*\
  !*** ./src/components/carbon_detailed_analysis.tsx ***!
  \*****************************************************/
...
const Organizational_Carbon_Detailed_Analysis = (props) => {
    ...
    const [scopeKey, setScopeKey] = (0, react_1.useState)(1);
...
/***/ "./src/components/carbon_emissions_category_breakdown.tsx":
/*!****************************************************************!*\
  !*** ./src/components/carbon_emissions_category_breakdown.tsx ***!
  \****************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const Emissions_Category_Breakdown = (props) => {
    ...
    function getScopeData(BusinessUnitKey, StartYear, StartMonth, EndYear, EndMonth) {
        props.uxpContext.executeAction("OrganizationalDetailedEmissionOverview-Dataprovider", "GetScopewiseOverview", { BusinessUnitKey, StartYear, StartMonth, EndYear, EndMonth }, { json: true })
            .then((res) => {
            console.log("response", res);
            setScopeData(res);
        })
    ...
    const [isPieChart, setIsPieChart] = (0, react_1.useState)(false);
    let [selected, setSelected] = react_1.default.useState("op-1");
    let [selected1, setSelected1] = react_1.default.useState("op-1");
    let [selected2, setSelected2] = react_1.default.useState("op-1");
    ...
    return (react_1.default.createElement(components_1.WidgetWrapper, null,
        ...
        react_1.default.createElement("div", { className: "scope1_breakdown_widget" },
            react_1.default.createElement(components_1.WidgetWrapper, null,
                react_1.default.createElement(components_1.TitleBar, { title: `${toggleFilterValue} BreakDown` },
                    react_1.default.createElement("div", { className: "top-filter" },
                        react_1.default.createElement("div", { className: "toggle-btn" },
                            react_1.default.createElement("em", { className: "chart_label barchart_label" }, "Bar Chart "),
                            react_1.default.createElement("label", { className: "switch" },
                                react_1.default.createElement("input", { type: "checkbox", checked: isPieChart, onChange: () => setIsPieChart(!isPieChart) }),
                                react_1.default.createElement("span", { className: "slider" })),
                            react_1.default.createElement("em", { className: "chart_label piechart_label" }, "Pie Chart ")),
...
const Configuration = (props) => {
    ...
    const [showModal3, setShowModal3] = (0, react_1.useState)(false);
    const [showModal4, setShowModal4] = (0, react_1.useState)(false);
    const [editingRow1, setEditingRow1] = (0, react_1.useState)(null);
    const [editingRow2, setEditingRow2] = (0, react_1.useState)(null);
    const [editingRow3, setEditingRow3] = (0, react_1.useState)(null);
    let [selected, setSelected] = react_1.default.useState("");
    let [selected1, setSelected1] = react_1.default.useState("");
    let [selected2, setSelected2] = react_1.default.useState("");
    let [selected3, setSelected3] = react_1.default.useState("Kamal");
    let toast = (0, components_1.useToast)();
    let [ClientFilter, setClientFilter] = react_1.default.useState('0');
    let [MainUnitFilter, setMainUnitFilter] = react_1.default.useState('0');
    let [SubUnitFilter, setSubUnitFilter] = react_1.default.useState('0');
    ...
    const [tableData3, setTableData3] = (0, react_1.useState)([
    ...
    const [modalInputValues1, setModalInputValues1] = (0, react_1.useState)({ client: "", bu: "", user_group: "", name: "" });
    const [modalCheckboxes1, setModalCheckboxes1] = (0, react_1.useState)({ is_active: false });
    ...
    const handleSaveModal3 = () => {
        var _a, _b, _c;
        const newData = {
            client: ((_a = ClientFilterList.find(c => c.ClientKey === ClientFilter)) === null || _a === void 0 ? void 0 : _a.ClientID) || "",
            bu: ((_b = MainUnitFilterList.find(b => b.BusinessUnitKey === MainUnitFilter)) === null || _b === void 0 ? void 0 : _b.BusinessUnitName) || "",
            user_group: ((_c = SubUnitFilterList.find(s => s.BusinessUnitKey === SubUnitFilter)) === null || _c === void 0 ? void 0 : _c.BusinessUnitName) || "",
            name: selected3,
            is_active: modalCheckboxes1.is_active ? "Yes" : "No",
    ...
    { /* { id: 1, client: 'Pruksha', bu: 'Vimit', user_group: 'CEO User', name: 'Kamal', is_active:'No', index: 0 }, */ }
    const renderTableData1 = (data, editClick, deleteClick) => {
        return (react_1.default.createElement("div", { className: "data-list-container has-footer" },
            react_1.default.createElement("div", { className: "data-list" },
                react_1.default.createElement("table", { className: "data-table" },
                    react_1.default.createElement("thead", null,
                        react_1.default.createElement("tr", null,
                            react_1.default.createElement("th", null, "Client"),
                            react_1.default.createElement("th", null, "BU"),
                            react_1.default.createElement("th", null, "User Group"),
                            react_1.default.createElement("th", null, "Name"),
                            react_1.default.createElement("th", null, "Is Active"),
                            react_1.default.createElement("th", null))),
                    react_1.default.createElement("tbody", null, data.map(({ id, client, bu, user_group, name, is_active }, index) => (react_1.default.createElement("tr", { key: id, className: "data-list-item" },
                        react_1.default.createElement("td", null,
                            react_1.default.createElement("div", { className: "item-card" }, client)),
                        react_1.default.createElement("td", null,
                            react_1.default.createElement("div", { className: "item-card" }, bu)),
                        react_1.default.createElement("td", null,
                            react_1.default.createElement("div", { className: "item-card" }, user_group)),
                        react_1.default.createElement("td", null,
                            react_1.default.createElement("div", { className: "item-card" }, name)),
                        react_1.default.createElement("td", null,
                            react_1.default.createElement("div", { className: "item-card" }, is_active)),
                        react_1.default.createElement("td", null,
                            react_1.default.createElement("div", { className: "item-card" },
                                react_1.default.createElement("div", { className: "edit-icon", onClick: () => editClick(index) }),
                                react_1.default.createElement("div", { className: "delete-icon", onClick: () => deleteClick(index) })))))))))));
    };
    const renderContent = () => {
        switch (activeItem) {
            ...
            case 3: return (react_1.default.createElement("div", { className: "bu-content" },
                react_1.default.createElement("div", { className: "add-icon", onClick: addClick }),
                react_1.default.createElement("div", { style: { marginTop: "2.5em" } }, renderTableData1(tableData3, editClick3, deleteClick3))));
            default: return null;
        }
    };
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(components_1.WidgetWrapper, null,
            ...
            react_1.default.createElement("div", { className: "configuration-overall" },
                react_1.default.createElement("div", { className: "configuration-sidebar" },
                    ...
                    react_1.default.createElement("div", { className: `sidebar-list ${activeItem === 3 ? 'active' : ''}`, onClick: () => handleItemClick(3) }, "BU Users")),
        ...
        react_1.default.createElement(components_1.Modal, { title: editingRow3 !== null ? "Edit BU Users" : "Add BU Users", className: "congig-popup", show: showModal3, onClose: () => setShowModal3(false) },
            react_1.default.createElement("div", { className: "congig-popup-cont" },
                react_1.default.createElement("ul", null,
                    react_1.default.createElement("li", null,
                        react_1.default.createElement(components_1.Label, null, "Client"),
                        react_1.default.createElement("span", null,
                            react_1.default.createElement(components_1.Select, { selected: ClientFilter, options: ClientFilterList, labelField: "ClientID", valueField: "ClientKey", onChange: (value) => { setClientFilter(value); }, placeholder: " -- select --", isValid: selected ? (selected === null || selected === void 0 ? void 0 : selected.length) > 0 : null }))),
                    react_1.default.createElement("li", null,
                        react_1.default.createElement(components_1.Label, null, "Main BU"),
                        react_1.default.createElement("span", null,
                            react_1.default.createElement(components_1.Select, { selected: MainUnitFilter, options: MainUnitFilterList, labelField: "BusinessUnitName", valueField: "BusinessUnitKey", onChange: (value) => { setMainUnitFilter(value); }, placeholder: " -- select --", isValid: selected1 ? (selected1 === null || selected1 === void 0 ? void 0 : selected1.length) > 0 : null }))),
                    react_1.default.createElement("li", null,
                        react_1.default.createElement(components_1.Label, null, "Sub BU"),
                        react_1.default.createElement("span", null,
                            react_1.default.createElement(components_1.Select, { selected: SubUnitFilter, options: SubUnitFilterList, labelField: "BusinessUnitName", valueField: "BusinessUnitKey", onChange: (value) => { setSubUnitFilter(value); }, placeholder: " -- select --", isValid: selected2 ? (selected2 === null || selected2 === void 0 ? void 0 : selected2.length) > 0 : null }))),
                    react_1.default.createElement("li", null,
                        react_1.default.createElement(components_1.Label, null, "Name"),
                        react_1.default.createElement("span", null,
                            react_1.default.createElement(components_1.Select, { selected: selected3, options: [
                                    { label: "Kamal", value: "Kamal" },
                                    { label: "Namal", value: "Namal" },
                                ], onChange: (value) => { setSelected3(value); }, placeholder: " -- select --", isValid: selected3 ? (selected3 === null || selected3 === void 0 ? void 0 : selected3.length) > 0 : null }))),
                    react_1.default.createElement("li", null,
                        react_1.default.createElement(components_1.FormField, { inline: true, className: "showcase-checkbox" },
                            react_1.default.createElement(components_1.Checkbox, { checked: modalCheckboxes1.is_active, onChange: (checked) => setModalCheckboxes1(Object.assign(Object.assign({}, modalCheckboxes1), { is_active: checked })), label: "Active" }))),
                    react_1.default.createElement("li", { className: "save-list" },
                        react_1.default.createElement(components_1.Button, { title: "Save", onClick: handleSaveModal3 })))))));
};
...
const carbon_detailed_analysis_1 = __importDefault(__webpack_require__(/*! ./components/carbon_detailed_analysis */ "./src/components/carbon_detailed_analysis.tsx"));
const carbon_emissions_category_breakdown_1 = __importDefault(__webpack_require__(/*! ./components/carbon_emissions_category_breakdown */ "./src/components/carbon_emissions_category_breakdown.tsx"));
...
(0, uxp_1.registerWidget)({
    ...
    widget: carbon_detailed_analysis_1.default,
    configs: {
        layout: {
        // w: 12,
        // h: 12,
...
(0, uxp_1.registerWidget)({
    ...
    widget: carbon_emissions_category_breakdown_1.default,
    configs: {
        layout: {
        // w: 12,
        // h: 12,
