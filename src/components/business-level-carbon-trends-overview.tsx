...
const Business_Level_Carbon_Trends_Overview: React.FunctionComponent<IWidgetProps> = (props) => { 
...
const consumptionCompositionData = [
    ...
    return (
        <WidgetWrapper className="carbon-trends-overview">
            <TitleBar title='Business-Level Carbon Trends Overview' icon="https://static.iviva.com/images/Udhayimages/alert-trends.png">
...
export default Business_Level_Carbon_Trends_Overview;
